                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="w-full grid gap-2 grid-cols-2">
                                        ...
                                        <div className="border flex flex-col p-4 border-white shadow-md justify-center rounded-md bg-gradient-to-tl from-gray-200 to-air_cold">
                                            ...
                                            <a href={project.designer_page} target="_blank" className="lg:text-xl text-sm hover:cursor-pointer hover:text-deep_sea transition-colors underline font-medium ">{project.designer}</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
