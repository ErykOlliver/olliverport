...
export default function Projects() {
    return (
        <section className="Home bg-air_cold/95 pt-24 w-full h-full flex justify-center items-center">
            ...
            <div className="w-[90%] flex flex-col text-pure_graphite font-poppins justify-start items-center h-full">
