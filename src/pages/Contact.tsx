...
export default function Contact() {
    return (
        <section className=" bg-air_cold/90 w-full h-full flex justify-center items-center">
            ...
            <div className="no-scroll w-[90%] flex flex-col gap-2.5 overflow-y-auto overflow-x-hidden text-pure_graphite font-poppins justify-start items-center h-full">
                <div className="w-fit h-full flex flex-col gap-3.5 justify-center items-center text-center">
                    <h1 className="font-semibold text-3xl lg:text-5xl animate-slide-to-left">Vamos conversar?</h1>
                    <p className="lg:text-2xl text-xs text-pure_graphite/60 animate-slide-to-left" >Entre em contato comigo pelo canal que preferir. Respondo em poucas horas.</p>
                    <div className="flex lg:flex-row flex-col w-full items-center justify-between gap-3.5">
                        ...
                        <p className="lg:text-2xl text-xs text-pure_graphite/60 animate-slide-to-left" >ou</p>
