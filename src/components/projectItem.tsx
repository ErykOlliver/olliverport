...
export default function ProjectItem(props: props) {
    ...
    return (
        <div
            ...
            className="animate-slide-to-left group w-100 border-white transition-all  flex flex-col gap-3.5 justify-between font-poppins  bg-gradient-to-tl from-gray-200 to-air_cold p-2.5 hover:shadow-[0_2px_10px] shadow-black/60 duration-300 border" >
            ...
            <article className="flex flex-col gap-3.5">
                ...
                <h3 className="text-xl text-pure_graphite/60">{limitText(props.summary, 60)}</h3>
                <div className="w-full flex-wrap flex gap-1.5 justify-start items-start">
